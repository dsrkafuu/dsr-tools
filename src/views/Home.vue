...
.home {
  ...
  background: url('https://cdn.jsdelivr.net/gh/dsrkafuu/dsr-api@1/dsr-tools/home/cover-row.webp')
    no-repeat center center fixed;
  background-size: cover;

  @media screen and (max-width: 900px) {
    background: url('https://cdn.jsdelivr.net/gh/dsrkafuu/dsr-api@1/dsr-tools/home/cover-col.webp')
      no-repeat center center fixed;
    background-size: cover;
  }
}
