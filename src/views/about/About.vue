<template>
  <v-container class="py-10 px-10 mb-10">
    <div class="row">
      <div class="col-12 col-md-6">
        <v-subheader>作者相关</v-subheader>
        <v-card class="mx-4">
          <v-list-item>
            <v-list-item-avatar>
        ...
        <v-subheader class="mt-5">版权声明</v-subheader>
